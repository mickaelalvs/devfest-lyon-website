...
export const roomASchedule: Talk[] = [
    ...
    speakers: [
      {
        name: 'Marie Terrier',
        avatar:
          'https://media.licdn.com/dms/image/v2/D4E03AQHRX4a4Y8KA-g/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1732268160555?e=2147483647&v=beta&t=TQo_3WBS4K6-gEg0c5ViJ8jYIUdcqY8RVS31GeJaDkA',
      },
    ],
    description:
  ...
  },
  {
    ...
    speakers: [
      {
        name: 'Tim Carry',
        avatar: 'https://pbs.twimg.com/profile_images/601300425715908608/0Z1RJjQ8_normal.jpg',
      },
    ],
    description:
      '| - Mais si tu sais, c\'est quand il dit "Capitaine ! Capitaine ! Vous n\'êtes pas le capitaine !"\n' +
      '\n' +
  ...
  },
  {
    ...
    description:
      'Vous connaissez les attributs "aria" et vous savez qu\'il faut mettre des "alt" sur vos images ?\n' +
    ...
    speakers: [
      {
        ...
        avatar:
          'https://media.licdn.com/dms/image/v2/D4E03AQG8TaSTBYe0LQ/profile-displayphoto-scale_200_200/B4EZgNm5Q1HoAg-/0/1752574957108?e=1758153600&v=beta&t=YanrMZgchZJDqayHiaPmbNUaQVN90YC3NVI6EEv__xs',
      },
    ],
    description:
      "Découvrez comment l'intelligence artificielle générative (GenAI) révolutionne la personnalisation des QR Codes !\n" +
      '\n' +
...
export const roomBSchedule: Talk[] = [
  ...
  },
  {
    ...
    theme: '🗃️ Backend',
    speakers: [{ name: 'Erwan Le Tutour', avatar: 'https://avatars.githubusercontent.com/u/21158564?v=4' }],
    description:
  ...
  },
  {
    ...
    description:
      "Il fut un temps où jQuery a révolutionné le développement web: fini les galères de compatibilité entre navigateurs, place à la simplicité et à l'efficacité. Les développeurs pouvaient enfin se concentrer sur leur app, pas sur les bugs.\n" +
      '\n' +
    ...
    speakers: [
      {
        ...
        avatar: 'https://avatars0.githubusercontent.com/u/26224751?v=4',
      },
    ],
    description:
