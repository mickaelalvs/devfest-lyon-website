    ...
    jobs: [
        {
            ...
            company: "Peaks",
            description: "Peaks est un partenaire conseil spécialisé dans la création de solutions numériques innovantes. Nous cherchons aujourd'hui un·e développeur·euse Node / React pour rejoindre notre équipe JavaScript.",
