...
export const indyJobs: SponsorJobs = {
    ...
    jobs: [
        ...
        },
        {
            ...
            location: "Lyon",
            type: "CDI",
            description: "En binôme avec David, Staff Engineer DevX, et directement rattaché au CTO, tu seras responsable de fluidifier et améliorer le quotidien de tous les développeur·euses d'Indy, en construisant et maintenant les outils qui soutiennent nos workflows.",
            fullDescription: "En binôme avec David, Staff Engineer DevX, et directement rattaché au CTO, tu seras responsable de fluidifier et améliorer le quotidien de tous les développeur·euses d'Indy, en construisant et maintenant les outils qui soutiennent nos workflows (outillage dev, CI/CD, plateformes cloud, monitoring…).\n\nTu seras directement responsable d'échanger avec les développeur·euses pour identifier leurs besoins et la meilleure manière d'y répondre.\n\nTu pourras compter sur la Guilde DevX qui rassemble des développeur·euses des différentes squads produit pour t'aider à diffuser les bonnes pratiques DevX dans les équipes, et pour accompagner les évolutions nécessaires de l'outillage.",
            responsibilities: [
