        ...
        >
            <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    En tant que membres, contributeur·trice·s et dirigeant·e·s, nous nous engageons à faire de la
                    participation à notre communauté une expérience sans harcèlement, quel que soit l&apos;âge, la
                    taille
                    corporelle, le handicap visible ou invisible, l&apos;appartenance ethnique, les caractéristiques
                    sexuelles, l&apos;identité et l&apos;expression de genre, le niveau d&apos;expérience,
                    l&apos;éducation,
                    le statut socio-économique, la nationalité, l&apos;apparence personnelle, la race, la religion, ou
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                            ...
                            <li>
                                Assumer ses responsabilités et s&apos;excuser auprès des personnes affectées par nos
                                erreurs et
                    ...
                    <div>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                            <li>
                                L&apos;utilisation de langage ou d&apos;images sexualisés et d&apos;attentions ou
                                d&apos;avances
                            ...
                            <li>
                                La publication d&apos;informations privées d&apos;autrui, telle qu&apos;une adresse
                                postale ou une
                                adresse électronique, sans leur autorisation explicite
                            </li>
                            <li>
            ...
            <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    ...
                    à
                    tout comportement qu&apos;ils ou elles jugent inapproprié, menaçant, offensant ou nuisible.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                    Les dirigeant·e·s de la communauté ont le droit et la responsabilité de supprimer, modifier ou
                    rejeter
                    les commentaires, les contributions, le code, les modifications de wikis, les rapports
                    d&apos;incidents
                    ou de bogues et autres contributions qui ne sont pas alignés sur ce code de conduite, et
                    communiqueront
                    les raisons des décisions de modération lorsque cela est approprié.
                </p>
            </section>
            ...
            <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    Ce code de conduite s&apos;applique à tous les espaces communautaires de DevFest Lyon, et
                    s&apos;applique également lorsqu&apos;un individu représente officiellement la communauté dans les
                    espaces publics. Les exemples de représentation de notre communauté incluent l&apos;utilisation
                    d&apos;une adresse e-mail officielle, la publication via un compte de réseau social officiel ou
                    l&apos;intervention en tant que représentant·e désigné·e lors d&apos;un événement en ligne ou
                    hors-ligne.
                </p>
            </section>
            ...
            <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    Tous les dirigeant·e·s de la communauté sont tenus de respecter la vie privée et la sécurité des
            ...
            <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    Les dirigeant·e·s de communauté suivront ces directives d&apos;application sur l&apos;impact
                    communautaire afin de déterminer les conséquences de toute action qu&apos;ils jugent contraire au
                ...
                <div className="space-y-6 mt-4">
                    <div className="bg-background rounded-lg border p-4">
                        ...
                        <p className="text-muted-foreground">
                            <strong>Impact communautaire</strong> : Utilisation de langage inapproprié ou tout autre
                            comportement jugé non professionnel ou indésirable dans la communauté.
                        </p>
                        <p className="text-muted-foreground mt-2">
                            <strong>Conséquence</strong> : Un avertissement écrit et privé de la part des dirigeant·e·s
                            de la
                            communauté, clarifiant la nature de la violation et expliquant pourquoi le comportement
                            était
                    ...
                    <div className="bg-background rounded-lg border p-4">
                        ...
                        <p className="text-muted-foreground">
                            <strong>Impact communautaire</strong> : Une violation par un seul incident ou une série
                            d&apos;actions.
                        </p>
                        <p className="text-muted-foreground mt-2">
                            <strong>Conséquence</strong> : Avertissement avec conséquences pour le comportement continu.
                            Aucune
                            interaction avec les personnes concernées, y compris l&apos;interaction non sollicitée avec
                            ceux et
                            celles qui sont chargé·e·s de l&apos;application de ce code de conduite, pendant une période
                            déterminée. Cela comprend l&apos;évitement des interactions dans les espaces communautaires
                            ainsi
                            que sur les canaux externes comme les médias sociaux. Le non-respect de ces conditions peut
                            conduire
                            à un bannissement temporaire ou permanent.
                        </p>
                    </div>
                    ...
                    <div className="bg-background rounded-lg border p-4">
                        ...
                        <p className="text-muted-foreground">
                            <strong>Impact communautaire</strong> : Une violation grave des normes communautaires,
                            notamment un
                            comportement inapproprié soutenu.
                        </p>
                        <p className="text-muted-foreground mt-2">
                            <strong>Conséquence</strong> : Bannissement temporaire de toute interaction ou communication
                            avec la
                            communauté pendant une période déterminée. Aucune interaction publique ou privée avec les
                            personnes
                            concernées, y compris les interactions non sollicitées avec celles et ceux qui appliquent ce
                            code de
                            conduite, n&apos;est autorisée pendant cette période. Le non-respect de ces conditions peut
                            conduire
                            à un bannissement permanent.
                        </p>
                    </div>
                    ...
                    <div className="bg-background rounded-lg border p-4">
                        ...
                        <p className="text-muted-foreground">
                            <strong>Impact communautaire</strong> : Démontrer un schéma récurrent de violation des
                            normes de la
                            communauté, y compris un comportement inapproprié soutenu, le harcèlement d&apos;un
                            individu, ou
                            l&apos;agression ou le dénigrement de catégories d&apos;individus.
                        </p>
                        <p className="text-muted-foreground mt-2">
                            <strong>Conséquence</strong> : Bannissement permanent de toute interaction publique au sein
                            de la
                            communauté.
                        </p>
                    </div>
