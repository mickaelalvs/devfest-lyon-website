    ...
    <div className="container px-4 md:px-6">
      ...
      >
        <div className="space-y-2 flex flex-col items-center justify-center gap-2">
          <div className="inline-block rounded-lg bg-red/10 px-3 py-1 text-sm text-red">Première édition</div>
      ...
      <div className="mx-auto grid max-w-6xl items-center py-12 lg:grid-cols-[3fr_2fr] lg:gap-12 gap-12">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Image src={Embarcadere} alt="Conference Venue" fill className="object-cover" />
        </motion.div>
        <motion.div
