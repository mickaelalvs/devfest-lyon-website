    ...
    <div className="container px-4 md:px-6">
      <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">Des talks captivants au cœur de la Ville des Lumières ✨</p>
        </div>
        <div className="space-y-4" />
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link href="/2025" className="text-muted-foreground hover:text-primary transition-colors">
                Accueil
              </Link>
            </li>
            <li>
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-2">
            ...
            <Link
              href="https://bsky.app/profile/devfestlyon.bsky.social"
              target="_blank"
              rel="noopener noreferrer"
