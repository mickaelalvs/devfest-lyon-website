    ...
    <div className="container px-4 md:px-6">
      ...
      >
        <div className="space-y-2">
          <div className="inline-block rounded-lg bg-navy/10 px-3 py-1 text-sm text-navy">Call for Papers</div>
      ...
      >
        <div className="inline-block relative">
          <div className="absolute -inset-1 bg-gradient-to-r from-navy to-primary rounded-full blur opacity-30"></div>
          <div className="relative bg-background rounded-full px-6 py-3 border border-navy/10 inline-flex items-center gap-2">
            <Calendar className="h-5 w-5 text-navy" />
            <span className="font-medium text-navy">
              Date du CFP : <strong>Du 16 avril au 15 juin 2025</strong>
            </span>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        >
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-navy to-primary rounded-lg blur opacity-30"></div>
            <div className="relative bg-background rounded-lg p-6 shadow-xl border border-navy/10">
              ...
              <p className="text-muted-foreground mb-6">
                Nous recherchons des conférenciers pour partager leurs idées sur le développement web, mobile, cloud, AI/ML, DevOps, et bien
                plus encore. Notre CFP est ouvert, et cela jusqu'au 15 juin 2025.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Lightning talks de 20 minutes, Talks de 45 minutes</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Billet gratuit pour la conférence</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Toutes les candidatures sont examinées par notre comité et les notifications seront envoyées début août.
                    </p>
                  </div>
                </div>
              </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4">
            {['📏 Frontend', '🗃️ Backend', '🔧 Cloud, Infra & DevOps', '📊 Data & AI', '📝 Software Architecture'].map((topic, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -5 }}
