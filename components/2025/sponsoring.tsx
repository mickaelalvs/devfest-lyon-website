          ...
          <div className="relative p-8 rounded-2xl overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground mb-6">
                Vous souhaitez sponsoriser le DevFest Lyon ? Faites participer vos équipes, obtenez de la visibilité et entrez en contact
                avec des personnes passionnées !
              </p>
              <Button
                size="lg"
              ...
              >
                <Link
                  ...
                  href="https://drive.google.com/drive/folders/1oxVgRUWi45pTqygUPU15ZGXy7-MFfIVz?usp=drive_link"
                >
                  Pack de sponsorship
