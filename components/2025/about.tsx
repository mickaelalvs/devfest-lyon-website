    ...
    <div className="container px-4 md:px-6">
      <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="inline-block rounded-lg bg-primary/10 px-3 py-1 text-sm text-primary">C'est quoi cet événement ?</div>
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-primary">À propos de DevFest Lyon</h2>
          <p className="text-muted-foreground md:text-xl pt-4">
            Organisée par l'association DevFest Lyon et portée par le Google Developer Group (GDG) Lyonnais, la première édition à Lyon est
            une opportunité unique pour partager et échanger autour de thématiques techniques dans la région lyonnaise.
          </p>
