        ...
        <div className="container px-4 md:px-6">
            ...
            >
                <div className="space-y-2 flex flex-col items-center justify-center gap-2">
                    <div className="inline-block rounded-lg bg-yellow/10 px-3 py-1 text-sm text-yellow">Ils soutiennent
                        l'événement
                    </div>
                ...
                <div className="space-y-10 mt-8 w-full pt-15">
                    <motion.div
                        ...
                        className="space-y-4"
                    >
                        <h3 className="text-5xl font-bold text-foreground pb-6">Sponsors <span className="uppercase font-black text-yellow-400">Gold</span></h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {goldSponsors.map((sponsor, i) => (
                                <Link key={sponsor.name} href={sponsor.website} target="_blank" rel="noopener noreferrer"
                    ...
                    >
                        <h3 className="text-4xl font-bold text-foreground pb-6">Sponsors <span className="uppercase font-black text-gray-500">Silver</span></h3>
                                ...
                                >
                                    ...
                                    >
                                        <Image
                                            ...
                                            width={150}
                                            height={50}
                                            className="max-h-20 !h-auto max-w-180"
                                        />
                                    </motion.div>
                                </Link>
                            ))}
                    ...
                    <motion.div
                        ...
                        className="space-y-4 mt-15"
                    >
                        <h3 className="text-4xl font-bold text-foreground pb-6">Sponsor <span className="uppercase font-black text-lime-600">Meet & Greet</span></h3>
