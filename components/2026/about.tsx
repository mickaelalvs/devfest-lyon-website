            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                ...
                >
                    <p className="text-muted-foreground md:text-xl pt-4">
                        ...
                        la deuxième édition du DevFest Lyon revient pour une nouvelle journée de partage et d'échanges
                        autour de thématiques techniques dans la région lyonnaise.
                    </p>
