      ...
      <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
        ...
        >
          <div className="space-y-2 flex flex-col items-center gap-2">
            <div className="inline-block rounded-lg bg-pink/10 px-3 py-1 text-sm text-pink">Complet</div>
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-pink pt-4">S'inscrire au DevFest Lyon 2025</h2>
