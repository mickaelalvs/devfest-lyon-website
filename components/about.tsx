...
export const About = () => (
    <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-primary/5">
        <div className="container px-4 md:px-6">
            <div className="mx-auto grid max-w-10xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
                <motion.div
                ...
                >
                    ...
                    <div className="space-y-4 pt-4">
                        ...
                        <ul className="ml-6 space-y-4 text-muted-foreground text-xl">
                            <li className="flex items-center gap-2">
                                <Users className="h-6 w-6 text-red" />
                                <span>250 personnes passionnées des technologies de demain</span>
                            </li>
                            <li className="flex items-center gap-2">
                            ...
                            <li className="flex items-center gap-2">
                                ...
                                <span>Deux tracks de talks techniques avec des intervenants experts</span>
                            </li>
                            <li className="flex items-center gap-2">
                                <Handshake className="h-6 w-6 text-yellow" />
                                <span>Du partage avec des expertes et experts de la tech</span>
                            </li>
                        </ul>
                    </div>
                </motion.div>
