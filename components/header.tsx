...
export const Header = () => {
    ...
    return (
        <Fragment>
            <header
                className="block sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 overflow-hidden">
                    ...
                    <div className="w-full flex items-center justify-between min-w-0">
                        ...
                        {is2025 && (
                            <nav className="hidden md:flex gap-2 flex-shrink-0">
                                ...
                                <Link href="/2025/code-of-conduct"
