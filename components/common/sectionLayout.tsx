        ...
        <section id={id} className={cn("w-full py-12 md:py-24 lg:py-32", color.background)}>
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center gap-4 text-center mb-8">
                    <div className={`inline-block rounded-lg px-3 py-1 text-sm ${color.pill}`}>
                        {pill}
                    </div>
                    <h2 className={`text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl ${color.title}`}>
                        {title}
                    </h2>
                </div>
                {children}
