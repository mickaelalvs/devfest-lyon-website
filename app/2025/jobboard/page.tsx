                                    ...
                                    >
                                        ...
                                        {sponsor.jobs.length === 0 ? (
                                            <p className="text-center text-muted-foreground text-lg">
                                                Les offres de {sponsor.sponsorName} arriveront bientôt.
                                            </p>
                                        ) : (
                                            <div className="flex flex-wrap justify-center gap-6 items-stretch">
                                                {sponsor.jobs.map((job) => {
                                                    ...
                                                    return (
                                                    <Card key={job.id} className={`hover:shadow-lg transition-shadow w-full max-w-lg md:w-[calc(50%-0.75rem)] ${colorScheme.border} ${colorScheme.bg} border-4 flex flex-col`}>
                                                        <CardHeader>
