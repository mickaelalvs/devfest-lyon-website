...
const description =
  "Découvrez les offres d'emploi de nos sponsors du DevFest Lyon 2025. Explorez les opportunités de carrière dans les entreprises tech qui soutiennent notre événement et postulez directement.";
